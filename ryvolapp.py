        ...
        "categories": [
            ...
            {"id": "ritual_ceremony", "name": "Ritual & Ceremony", "date": "July 17, 2026",
             "tasks": [
                 ...
                 {"id": "t11_kid", "name": "Pahandi Volunteer (Anasara → Ratnabedi) (🧒 1 Kid >=10years)", "slots": 1,
                  "slot_icons": ["🧒"]},
                 {"id": "t11_male", "name": "Pahandi Volunteer (Anasara → Ratnabedi) (👨 8 Adult Male)", "slots": 8,
                  "slot_icons": ["👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨"]},
                 {"id": "t11_female", "name": "Pahandi Volunteer (Anasara → Ratnabedi) (👩 4 Adult Female)", "slots": 4,
                  "slot_icons": ["👩", "👩", "👩", "👩"]},
             ]},
        ...
        "categories": [
            ...
            {"id": "event_ritual", "name": "Event Ritual & Ceremony", "date": "July 18, 2026",
             ...
             "tasks": [
                 ...
                 {"id": "t26_leads", "name": "Pahandi Volunteer (Ratnabedi → Ratha) (⭐ 3 Leads)", "slots": 3,
                  "slot_icons": ["⭐", "⭐", "⭐"]},
                 {"id": "t26_kids", "name": "Pahandi Volunteer (Ratnabedi → Ratha) (🧒 2 Kids >=10years)", "slots": 2,
                  "slot_icons": ["🧒", "🧒"]},
                 {"id": "t26_male", "name": "Pahandi Volunteer (Ratnabedi → Ratha) (👨 24 Adult Male)", "slots": 24,
                  "slot_icons": ["👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨"]},
                 {"id": "t26_female", "name": "Pahandi Volunteer (Ratnabedi → Ratha) (👩 12 Adult Female)", "slots": 12,
                  "slot_icons": ["👩", "👩", "👩", "👩", "👩", "👩", "👩", "👩", "👩", "👩", "👩", "👩"]},
                 {"id": "t27", "name": "Deepam Arati (Adapa Mandapa)", "slots": 1},
                 {"id": "t28", "name": "Paana", "slots": 1},
                 {"id": "t29_leads", "name": "Pahandi Volunteer (Ratha → Adapa Mandapa) (⭐ 3 Leads)", "slots": 3,
                  "slot_icons": ["⭐", "⭐", "⭐"]},
                 {"id": "t29_kids", "name": "Pahandi Volunteer (Ratha → Adapa Mandapa) (🧒 1 Kid >=10years)", "slots": 1,
                  "slot_icons": ["🧒"]},
                 {"id": "t29_male", "name": "Pahandi Volunteer (Ratha → Adapa Mandapa) (👨 12 Adult Male)", "slots": 12,
                  "slot_icons": ["👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨"]},
                 {"id": "t29_female", "name": "Pahandi Volunteer (Ratha → Adapa Mandapa) (👩 6 Adult Female)", "slots": 6,
                  "slot_icons": ["👩", "👩", "👩", "👩", "👩", "👩"]},
        ...
        "categories": [
            ...
            {"id": "ritual_ceremony", "name": "Ritual & Ceremony", "date": "July 26, 2026",
             "tasks": [
                 ...
                 {"id": "t12_kids", "name": "Pahandi Volunteer (Adapa Mandapa → Ratnabedi) (🧒 2 Kids >=10years)", "slots": 2,
                  "slot_icons": ["🧒", "🧒"]},
                 {"id": "t12_male", "name": "Pahandi Volunteer (Adapa Mandapa → Ratnabedi) (👨 12 Adult Male)", "slots": 12,
                  "slot_icons": ["👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨", "👨"]},
                 {"id": "t12_female", "name": "Pahandi Volunteer (Adapa Mandapa → Ratnabedi) (👩 6 Adult Female)", "slots": 6,
                  "slot_icons": ["👩", "👩", "👩", "👩", "👩", "👩"]},
                 {"id": "t13", "name": "Coconut Purchase", "slots": 2},
                 {"id": "t16", "name": "Rasagola Preparation", "slots": 2},
                 {"id": "t17", "name": "Special Bhoga (Adapa Mandapa)", "slots": 2},
